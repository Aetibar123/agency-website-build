...
const seoFaqs = [
  {
    question: "How long does Technical SEO take to generate measurable organic growth?",
    answer:
      "Technical fixes (crawl errors, 301 redirect mapping, Core Web Vitals) typically reflect in Google Search Console within 2 to 6 weeks. Broad organic ranking and traffic growth compound over 3 to 6 months as content indexation deepens.",
  },
  {
    question: "How do you protect organic search traffic during a CMS or domain migration?",
    answer:
      "We build a comprehensive URL map with 1:1 permanent 301 redirects, validate canonical tags, preserve metadata and structured schema, test crawl behavior in staging, and monitor log files in real-time post-launch.",
  },
  {
    question: "What does your Technical SEO audit deliver?",
    answer:
      "A complete actionable audit covering Core Web Vitals metrics, indexation bottlenecks, redirect chains, orphan pages, structured data validation, mobile usability, and internal linking architecture.",
  },
  {
    question: "Do you guarantee #1 Google rankings?",
    answer:
      "No legitimate engineering or SEO agency can promise specific keyword positions due to search engine algorithmic variability. We guarantee rigorous technical excellence, speed compliance, and sustainable indexing practices.",
  },
];
        ...
        <Container maxWidth="xl">
          <Grid container spacing={{ xs: 6, lg: 8 }} sx={{ alignItems: "center" }}>
            <Grid size={{ xs: 12, lg: 7 }}>
              ...
              >
                <SearchOutlinedIcon sx={{ color: "#0E7490", fontSize: 18 }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: "#0E7490",
                ...
                >
                  ORGANIC VISIBILITY &bull; TECHNICAL SEO &bull; MIGRATIONS
                </Typography>
              </Box>
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, alignItems: "center", mb: 4 }}>
                ...
                >
                  Explore SEO Methodology
                </Button>
              </Box>

              <Box sx={{ display: "flex", gap: 3, alignItems: "center" }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <TrendingUpOutlinedIcon sx={{ fontSize: 22, color: "#0E7490" }} />
            ...
            <Grid size={{ xs: 12, lg: 5 }}>
              ...
              >
                ...
                >
                  <Image
                    src="/images/portfolio/seo-migration.png"
                    alt={service.title}
                    fill
                ...
                >
                  {[
                    { label: "INDEXATION AUDIT", val: "500K+ Pages Clean" },
                    { label: "301 MIGRATION MAP", val: "0% 404 Loss Rate" },
                    { label: "CORE WEB VITALS", val: "99+ Good URLs" },
                    { label: "SEMANTIC SCHEMA", val: "Schema.org Valid" },
                  ].map((metric) => (
                    <Box
                      key={metric.label}
                      sx={{
