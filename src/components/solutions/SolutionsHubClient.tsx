...
const domains: SolutionDomain[] = [
  {
    ...
    urlPath: "/solutions/business-website-development",
  ...
  },
  {
    ...
    num: "02",
    badge: "ZONE 02 // CRM & LEAD INFRASTRUCTURE",
    ...
    solution:
      "A centralized webhook pipeline that consolidates every inquiry instantly, sends automated confirmations, and routes leads to the right specialist without delay.",
    description:
      "When leads arrive across fragmented channels, inquiries get lost and follow-ups drag. We engineer unified intake pipelines and custom sales CRMs tailored to how your sales team operates—eliminating enterprise CRM bloat while ensuring every inquiry is accounted for.",
    icon: <HubOutlinedIcon sx={{ fontSize: 24, color: "#EA580C" }} />,
    capabilities: [
      "Multi-channel webhook lead consolidation (WhatsApp, Web, Email)",
      "Automated follow-up triggers and scheduled reminder workflows",
      "Customer self-service tracking and document exchange portals",
      "Clean pipeline visibility without hundreds of unnecessary enterprise fields",
      "Instant notification and assignment rules for high-value inquiries",
    ],
    metrics: {
      primary: "Centralized",
      primaryLabel: "Multi-Source Intake",
      secondary: "Structured",
      secondaryLabel: "Pipeline Tracking",
    },
    idealFor:
    ...
    urlPath: "/solutions/crm-lead-management",
  ...
  },
  {
    ...
    subtitle: "Operations Management, Scheduling & Workflow Software",
    headline: "Replace fragile spreadsheets with custom operational dashboards and workflow software.",
    problem:
      "Core operations run on fragile spreadsheets, staff double-book jobs, quotes are manually calculated with errors, and leadership lacks real-time operational visibility.",
    solution:
      "Custom internal web applications and dashboards built around your exact daily workflow—with built-in validation rules, mobile dispatch, and a centralized database.",
    description:
      "When core business operations run on fragile spreadsheets, dropped tasks and double-bookings become inevitable. We build custom operational dashboards, field dispatch tools, and quotation engines that give management complete clarity and operational control.",
    ...
    metrics: {
      primary: "Unified",
      primaryLabel: "Central Relational Database",
      secondary: "Conflict-Free",
      secondaryLabel: "Atomic Concurrency Control",
    },
    idealFor:
    ...
    urlPath: "/solutions/custom-business-software",
...
const diagnosticBottlenecks = [
  {
    ...
    recommendedPath: "/solutions/business-website-development",
    timeframe: "2 - 4 Weeks",
    keyDeliverables: [
  ...
  },
  {
    ...
    recommendedDomain: "CRM & Lead Systems",
    recommendedPath: "/solutions/crm-lead-management",
    timeframe: "3 - 5 Weeks",
    keyDeliverables: [
      "Unified multi-channel webhook queue (WhatsApp, Email, Web)",
      "Automated follow-up reminder sequences & notification alerts",
      "Custom sales pipeline dashboard and customer portal",
    ],
    expectedOutcome: "Immediate multi-channel inquiry capture, accountable team assignment, and structured pipeline tracking.",
  },
  {
    id: "spreadsheets",
    title: "Spreadsheet Chaos & Double-Booking",
    question: "Core operations run on 10+ sheets, manual dispatch calls, and untracked jobs.",
    recommendedDomain: "Custom Business Software",
    recommendedPath: "/solutions/custom-business-software",
    timeframe: "4 - 7 Weeks",
    keyDeliverables: [
